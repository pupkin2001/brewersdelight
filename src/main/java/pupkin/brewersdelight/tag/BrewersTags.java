...
public class BrewersTags
{
	...
	public static final TagKey<Item> CHALLENGE_DRINKS = modItemTag("challenge_beverages");
	public static final TagKey<Item> VINTAGE_DRINKS = modItemTag("vintage_beverages");
